...
<head>
    ...
    <link href="{{ asset('css/img_8_takephoto.css') }}" rel="stylesheet">
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row row-cols-1 row-cols-md-5 g-2 ms-5 me-5" style="margin-top: 5rem">
            ...
            @for ($i = 1; $i < 9; $i++) <div class="col col_8p">
                <div class="card bg_template_img">
                    <img src="" class="card-img-top d-none img_set_size" id="preview_{{$i}}">
                    <div class="text-center p-3 text_template_img" id="preview_txt_{{$i}}">
                        {{$i}}
                    </div>
                </div>
        </div>
...
<script>
    $(document).ready(function () {
        ...
        function upload_img() {
            ...
            window.location = '{{ url("/preview_video_8") }}';
        }
